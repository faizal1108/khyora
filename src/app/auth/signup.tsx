...
export default function SignupScreen() {
  ...
  const headerHeight = Math.min(Math.max(screenHeight * 0.28, 200), 280);
  ...
  const onSignup = async () => {
    ...
    if (!firebaseReady) {
      Alert.alert('Firebase not configured', 'Add your Firebase credentials to .env first.');
      return;
    }
      ...
      <View style={[styles.header, { height: headerHeight }]}>
        ...
        <SafeAreaView edges={['top']} style={styles.headerSafe}>
          <View style={styles.topRow}>
            <Text style={styles.topPrompt}>Already have an account?</Text>
            <Link href="/auth/login" asChild>
              ...
              >
                <Text style={styles.topActionLabel}>Sign In</Text>
              </Pressable>
            </Link>
          </View>
          ...
          >
            ...
            <View style={styles.passwordField}>
              <InputField
                ...
                labelStyle={fieldLabelStyle}
                style={[fieldInputStyle, styles.passwordInput]}
              />
              <Pressable
                accessibilityRole="button"
